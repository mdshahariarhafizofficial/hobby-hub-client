...
const DashboardAllGroups = () => {
    ...
    const [singleGroup, setSingleGroup] = useState(allGroups);
        ...
        if (result.isConfirmed) {
            ...
            .then(data => {
                if (data.deletedCount) {
                    const remainingData = allGroups.filter(group => group._id !== id);
                    setallGroups(remainingData)
                    Swal.fire({
                    title: "Deleted!",
    ...
    const sendUpdateDataToDb = (e) => {
        ...
        .then(data => {
            if (data.modifiedCount) {
                ...
                .then(res => res.json())
                .then(data => {
                    const updatedGroup = allGroups.map(group => group._id === data._id ? data : group);
    ...
    return (
        <div>
            <div>
                <h2 className='text-5xl dark:text-[#ff946a] font-bold text-center text-secondary'>ALL Groups</h2>
            ...
            <div className='mb-20'>
                ...
                <table className="table text-center">
                    ...
                    <tr key={group._id} className='border-secondary'>
                        ...
                        <td>{
                            <div>
                                <span className='text-red-500 font-medium'>Only the admin can take action</span>
                                <div className="join justify-center gap-7 hidden">
