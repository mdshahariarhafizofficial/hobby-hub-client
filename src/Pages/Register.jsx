            ...
            <div className="w-full max-w-2xl p-8 space-y-3 rounded-xl dark:bg-gray-50 shadow-2xl dark:text-gray-800 border-5 border-primary" bis_skin_checked="1">
                ...
                className="space-y-6">
                    ...
                    <div className="space-y-1 text-sm" bis_skin_checked="1">
                        ...
                        <input type="text" name="name" id="name" placeholder="Name" className="w-full px-4 py-3 rounded-md dark:bg-gray-50 dark:text-gray-800 focus:dark:border-violet-600 border-2 border-gray-300" />
                    </div>
                    {/* Photo */}
                    <div className="space-y-1 text-sm" bis_skin_checked="1">
                        <label htmlFor="Photo" className="block dark:text-gray-600">Photo URL</label>
                        <input type="text" name="photo" id="photo" placeholder="Photo Url" className="w-full px-4 py-3 rounded-md dark:bg-gray-50 dark:text-gray-800 focus:dark:border-violet-600 border-2 border-gray-300" />
                    </div>
                    {/* Email */}
                    <div className="space-y-1 text-sm" bis_skin_checked="1">
                ...
                <p className="text-xs text-center sm:px-6 dark:text-gray-600">Already have an account?
                    <Link to='/login' rel="noopener noreferrer" href="#" className="underline text-primary ml-1 font-bold">Login</Link>
                </p>
            </div>
        </div>
    );
